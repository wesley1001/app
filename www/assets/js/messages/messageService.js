...
define([
		...
		"bluebird"
	], function (step, h, messagesModule, Observer, sortedSet, SecuredData, Bluebird) {
	"use strict";
	...
	var service = function ($rootScope, $timeout, errorService, socket, sessionService, userService, keyStore, initService, Message) {
		var messages = {};
		var topics = {};
	...
	service.$inject = ["$rootScope", "$timeout", "ssn.errorService", "ssn.socketService", "ssn.sessionService", "ssn.userService", "ssn.keyStoreService", "ssn.initService", "ssn.models.message"];
